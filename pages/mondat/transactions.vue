...
export default {
  ...
  methods: {
    ...
    infiniteHandler: async function($state) {
      ...
      let url = `${this.$monitorEndpoint}/transactions?page=${this.page}&pagesize=${PAGESIZE}&status=running,queued,success,failed,aborted,sleeping,timeout,internal-error`
